...
public class Luigi : I2DPlatformPlayer
{
    ...
    public Luigi(IController controller, Vector2 startPosition, ContentManager Content)
    {
        TextureAtlas atlas = TextureAtlas.FromFile(Content, "images/luigi-definition.xml");
